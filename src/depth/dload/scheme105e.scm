;; scheme105e.scm
;;
;; barely modified version of Alex's CS105 HW3 which gets the intial basis
;; by dynamically loading `predef.scm`
...
;; modified this since records are no longer list sugar

        (check-expect (rightmost-point (list2 [make-point 1 2]
                                              [make-point 3 4])) 
                      [make-point 3 4])
        (check-expect (rightmost-point (list3 [make-point 5 6] 
                                              [make-point 1 2]
                                              [make-point 3 4])) 
                      [make-point 5 6])
